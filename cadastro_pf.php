						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="card mb-3 bg-light">
									...
									<div class="card-body">
										<form method="post" action="registro_pf.php">
											<div class="form-group col-md-6">
												<label>Nome:</label>
												<input type="text" placeholder="" class="form-control" name="nome_pf" required="requiored">
											</div>   
											<div class="form-group col-md-6">
												<label>Sobrenome:</label>
												<input type="text" placeholder="" class="form-control" name="sobrenome_pf" required="requiored">
											</div>  
											<div class="form-group col-md-6">
												<label>email:</label>
											...
											<div class="form-group col-md-6">
												<label>CPF:</label>
												<input type="text" maxlength="14" class="form-control" id="cpf" name="cpf" required="requiored" >

												<?php
												if($erro_cpf){
													echo '<font style="color:#FF0000"> Este CPF já existe</font>';
												}

												if($erro_cpf2){
													echo '<font style="color:#FF0000"> Entre com um CPF válido</font>';
												}
											...
											<div class="checkbox form-group col-md-6">
												<label>Faz parte do grupo de risco?</label><br>
												<label>
													<input type="checkbox" name="hipertensao" value="s"> Hipertenso
												</label><br>   
												<label>
													<input type="checkbox" name="asma" value="s"> Asmatico
												</label><br>
												<label>
													<input type="checkbox" name="diabet" value="s"> Diabetico
												</label><br>
												<label>
													<input type="checkbox" name="fuma" value="s"> Fumante
												</label><br> 
